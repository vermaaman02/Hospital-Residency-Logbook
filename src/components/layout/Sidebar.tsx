...
const facultyNavSections: NavSection[] = [
	...
	},
	{
		...
		items: [
			...
			{
				title: "Disaster Drills",
				href: "/dashboard/faculty/disaster-drills",
				icon: <Siren className="h-4 w-4" />,
				roles: ["faculty"],
				badgeKey: "disasterDrills",
			},
			{
				title: "Quality Improvement",
				href: "/dashboard/faculty/quality-improvement",
				icon: <ShieldCheck className="h-4 w-4" />,
				roles: ["faculty"],
				badgeKey: "qualityImprovement",
			},
			{
				title: "Logbook Reviews",
				href: "/dashboard/faculty/logbook-reviews",
				icon: <ClipboardCheck className="h-4 w-4" />,
				roles: ["faculty"],
				badgeKey: "logbookReviews",
			},
		],
	},
	{
...
const hodNavSections: NavSection[] = [
	...
	},
	{
		...
		items: [
			...
			{
				title: "Disaster Drills",
				href: "/dashboard/hod/disaster-drills",
				icon: <Siren className="h-4 w-4" />,
				roles: ["hod"],
				badgeKey: "disasterDrills",
			},
			{
				title: "Quality Improvement",
				href: "/dashboard/hod/quality-improvement",
				icon: <ShieldCheck className="h-4 w-4" />,
				roles: ["hod"],
				badgeKey: "qualityImprovement",
			},
			{
				title: "Logbook Reviews",
				href: "/dashboard/hod/logbook-reviews",
				icon: <ClipboardCheck className="h-4 w-4" />,
				roles: ["hod"],
				badgeKey: "logbookReviews",
			},
