/**
 * @module DisasterDrillsTable
 * @description Inline-editing table for Major Incident Planning / Disaster Management Drill /
 * Mass Casualty Management / Prehospital EM.
...
interface DisasterDrillsTableProps {
...
export function DisasterDrillsTable({
	entries,
	facultyList,
	onAddRow,
	onDeleteEntry,
	...
	// ---- Edit handlers ----
	function startEditing(entry: DisasterDrillEntry) {
	...
	function handleSubmit(entry: DisasterDrillEntry) {
	...
	function handleDelete(entry: DisasterDrillEntry) {
