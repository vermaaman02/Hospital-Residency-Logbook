/**
 * @module HodStudentCoursesPage
 * @description HOD page to view a specific student's life-support courses.
 *
...
export default async function HodStudentCoursesPage({ params }: Props) {
	...
	return (
		<div className="space-y-6">
			<div className="flex items-center gap-3">
				<Link href="/dashboard/hod/life-support-courses">
