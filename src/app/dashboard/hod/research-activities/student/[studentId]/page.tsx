/**
 * @module HodStudentResearchActivitiesPage
 * @description HOD page to view a specific student's research and outreach activity entries.
 *
...
export default async function HodStudentResearchActivitiesPage({
	params,
}: Props) {
	...
	return (
		<div className="space-y-6">
			<div className="flex items-center gap-3">
				<Link href="/dashboard/hod/research-activities">
