/**
 * @module HodRotationPostingStudentView
 * @description HOD view of a specific student's rotation postings (read-only).
...
export default async function HodRotationPostingStudentPage({
	params,
}: PageProps) {
