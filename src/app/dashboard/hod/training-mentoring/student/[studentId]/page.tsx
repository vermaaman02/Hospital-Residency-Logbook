/**
 * @module HodTrainingStudentView
 * @description HOD view of a specific student's training & mentoring records (read-only).
...
export default async function HodTrainingStudentPage({ params }: PageProps) {
			...
			<PageHeader
				...
				breadcrumbs={[
					{ label: "Dashboard", href: "/dashboard/hod" },
					{
						...
						href: "/dashboard/hod/training-mentoring",
					},
					{ label: studentName },
				]}
			/>
