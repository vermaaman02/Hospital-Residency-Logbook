/**
 * @module HodQualityImprovementPage
 * @description HOD review page for student quality improvement submissions.
 *
...
import { QualityImprovementReviewClient } from "../../faculty/quality-improvement/QualityImprovementReviewClient";

export const dynamic = "force-dynamic";

async function HodQualityImprovementContent() {
...
export default async function HodQualityImprovementPage() {
