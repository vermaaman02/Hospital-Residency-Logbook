/**
 * @module FacultyClinicalSkillStudentView
 * @description Faculty view of a specific student's clinical skill entries (read-only).
 * Accessed by clicking student name in the Clinical Skills review table.
 *
...
export default async function FacultyClinicalSkillStudentPage({
	params,
}: PageProps) {
