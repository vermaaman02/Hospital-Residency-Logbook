/**
 * @module FacultyThesisStudentView
 * @description Faculty view of a specific student's thesis record (read-only).
...
export default async function FacultyThesisStudentPage({ params }: PageProps) {
		...
		<div className="space-y-6">
			<PageHeader
				...
				breadcrumbs={[
					...
					{
						label: "Thesis Review",
						href: "/dashboard/faculty/thesis-review",
					},
					{ label: studentName },
				]}
			/>
