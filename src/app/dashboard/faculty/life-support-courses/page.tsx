/**
 * @module FacultyLifeSupportCoursesPage
 * @description Faculty review page for student life-support course submissions.
...
import { LifeSupportCoursesReviewClient } from "./LifeSupportCoursesReviewClient";

export const dynamic = "force-dynamic";

async function FacultyCoursesContent() {
...
export default async function FacultyLifeSupportCoursesPage() {
	...
	return (
		<div className="space-y-6">
			<PageHeader
				...
				description="Review and sign off student life-support course submissions"
			/>
