/**
 * @module FacultyAcademicStudentView
 * @description Faculty view of a specific student's case presentations and
...
export default async function FacultyAcademicStudentPage({
	params,
}: PageProps) {
