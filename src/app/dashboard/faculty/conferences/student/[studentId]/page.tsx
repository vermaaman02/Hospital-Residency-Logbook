/**
 * @module FacultyStudentConferencesPage
 * @description Faculty page to view a specific student's conference participations.
 *
...
export default async function FacultyStudentConferencesPage({ params }: Props) {
	...
	return (
		<div className="space-y-6">
			<div className="flex items-center gap-3">
				<Link href={`/dashboard/${role}/conferences`}>
