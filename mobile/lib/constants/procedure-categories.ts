/**
 * @module Procedure Categories Constants (Mobile)
 * @description All 49 procedure categories with display labels, target entry counts, and CPR flags.
 */
